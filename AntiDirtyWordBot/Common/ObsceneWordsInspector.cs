...
{
    public static class ObsceneWordsInspector
    {
        static readonly IEnumerable<string> Items = new[]
        {
            "6ля",
            "6лядь",
            "6лять",
        ...
        static readonly IEnumerable<(string, string[])> ExceptionWords = new[]
        {
        ...
        static readonly IEnumerable<(char, string[])> Alphabet = new[]
        {
            ('а', new string[]{ "а", "a", "@" }),
            ('б', new string[]{ "б", "6", "b" }),
            ('в', new string[]{ "в", "b", "v" }),
        ...
        public static double GetDistance(string originText, string template)
        {
